...
public class JdbcModifiedV2Converters {
  ...
  public interface JdbcModifiedV2ToBigQueryOptions extends CommonTemplateOptions {
    ...
    @TemplateParameter.Text(
        order = 7,
        description = "Table name used for fetching data",
        helpText = "JDBC compatible database table name",
