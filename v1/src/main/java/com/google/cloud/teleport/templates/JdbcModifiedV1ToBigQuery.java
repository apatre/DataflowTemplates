 ...
 */
@Template(
    name = "Modified Jdbc_to_BigQuery",
    category = TemplateCategory.BATCH,
    displayName = "Modified JDBC to BigQuery",
    description =
    ...
    optionsClass = JdbcModifiedV1Converters.JdbcModifiedV1ToBigQueryOptions.class,
    contactInformation = "https://cloud.google.com/support")
public class JdbcModifiedV1ToBigQuery {

  private static final Logger LOG = LoggerFactory.getLogger(JdbcModifiedV1ToBigQuery.class);
  ...
  public static void main(String[] args) {
    ...
    JdbcModifiedV1Converters.JdbcModifiedV1ToBigQueryOptions options =
        PipelineOptionsFactory.fromArgs(args)
            .withValidation()
            .as(JdbcModifiedV1Converters.JdbcModifiedV1ToBigQueryOptions.class);
