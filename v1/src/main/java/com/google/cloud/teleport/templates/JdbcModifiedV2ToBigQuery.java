...
@Template(
    ...
    optionsClass = JdbcModifiedV2Converters.JdbcModifiedV2ToBigQueryOptions.class,
    contactInformation = "https://cloud.google.com/support")
public class JdbcModifiedV2ToBigQuery {

  private static final Logger LOG = LoggerFactory.getLogger(JdbcModifiedV2ToBigQuery.class);
  ...
  public static void main(String[] args) {
    ...
    JdbcModifiedV2Converters.JdbcModifiedV2ToBigQueryOptions options =
        PipelineOptionsFactory.fromArgs(args)
            .withValidation()
            .as(JdbcModifiedV2Converters.JdbcModifiedV2ToBigQueryOptions.class);
